...
function stopBasket() {
        ...
        // ===== FISHING MINIGAME =====
        // All pond/river/lake/sea logic lives in game-fishing.js
        // completeFishing() below handles loot resolution for pond catches
...
// ===== GAME ACTIONS =====
        ...
        */
        ...
        // Field tap button (new minigame)
        const fieldTapBtn = document.getElementById('field-tap-btn');
        if (fieldTapBtn) fieldTapBtn.onclick = fieldTap;
        ...
        */
        ...
        console.log('Game version: v0.911');
